...
namespace DiGi.User.PostgreSQL
{
    public static partial class Create
    {
        ...
        /// <see cref="Classes.UserPostgreSQLConverter.SetUserCredentialAsync(UserCredential, int, System.Threading.CancellationToken)"/> to write it against an existing user.</para>
        /// </summary>
